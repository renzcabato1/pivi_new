			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row gy-4">
					<div class="col-lg-6">
						...
						<p>A Philippine-based management company with broad range of services for different industries, such as technology,
							aggregate supplies, construction development that provides world-class products and services to the Filipino
							people.</p>
					</div>
					<div class="col-lg-6">
						<div class="content ps-0 ps-lg-5">
							...
							<ul class='text-left'>
								<li><i class="bi bi-check-circle-fill text-left"></i> We value INTEGRITY “To do good and be good at all times”
								</li>
								<li><i class="bi bi-check-circle-fill"></i> We are COMMITTED to “Never make excuses, only results”</li>
								<li><i class="bi bi-check-circle-fill"></i> We value HUMILITY AND GENUINE CONCERN “Simplicity in enriching lives
									of the people</li>
								<li><i class="bi bi-check-circle-fill"></i> We are INNOVATIVE “There’s a way to do it better – find it” –
									(Thomas A. Edison)</li>
								<li><i class="bi bi-check-circle-fill"></i> We provide PREMIUM SERVICES “Quality Service beyond Expectation”
								</li>
								<li><i class="bi bi-check-circle-fill"></i> We work in SYNERGY “Alone we can do so little; Together we can do so
									much” – (Helen Keller)</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item  position-relative">
							...
							<h3>Construction</h3>
							<p>We deliver its unique brand of Engineering Excellence in projects for both PPP and private sectors. As an
								infrastructure conglomerate, its scope of work includes architectural work, BIM, MEPF, Line and Grade,
								Earthworks, and property development. </p>
							<a href="{{ url('construction') }}" class="readmore stretched-link">Read more <i
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item position-relative">
							...
							<h3>Real Estate</h3>
							<p>We envision to be a world-class developer of premium developments, forefront in sustainable and innovation to
								inspire and elevate the quality of life of every Filipino through thoughtfully designed real-estate.
							</p>
							<a href="{{ url('realestate') }}" class="readmore stretched-link">Read more <i
									class="bi bi-arrow-right"></i></a>
						</div>
					</div><!-- End Service Item -->
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item position-relative">
							...
							<h3>Manufacturing</h3>
							<p>One of the leading and largest suppliers, our company aims to make a positive impact through a sustainable and
								socio-economic business approach to be able to cater to the growing market of construction materials. </p>
							<a href="{{ url('manufacturing') }}" class="readmore stretched-link">Read more <i
									class="bi bi-arrow-right"></i></a>
						</div>
					</div><!-- End Service Item -->
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item position-relative">
							...
							<a href="{{ url('logistics') }}" class="readmore stretched-link">Read more <i
									class="bi bi-arrow-right"></i></a>
						</div>
					</div><!-- End Service Item -->
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item position-relative">
							...
							<h3>Ship Building</h3>
							<p>We provide the first shipyard in Eastern Visayas and the first to utilize marine airbag technology in Visayas
								...
								services.</p>
							<a href="{{ url('ship-building') }}" class="readmore stretched-link">Read more <i
									class="bi bi-arrow-right"></i></a>
						</div>
					</div><!-- End Service Item -->
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item position-relative">
							...
							<h3>E-Commerce</h3>
							<p>A trailblazer in the industry and the first Filipino-made e-commerce marketplace business solution that seeks
								to revolutionize the Philippine online and technology where everyone can easily access and experience, the
								fastest, most accurate, and most reliable quality e-commerce platform.</p>
							<a href="{{ url('e-building') }}" class="readmore stretched-link">Read more <i
									class="bi bi-arrow-right"></i></a>
						</div>
					</div><!-- End Service Item -->
